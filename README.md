...
- **Кастомні веб-шорткати** — будь-який сайт (Notion, Linear, Claude тощо); підтримується іконка зі списку або перша літера назви; кожен шорткат має власну ізольовану сесію — можна мати декілька акаунтів одного сайту
- **Посилання з чатів в браузері** — зовнішні посилання з Telegram і WhatsApp відкриваються в Google Chrome
- **Перетягування файлів** — скріншоти та інші файли можна перетягнути прямо в чат месенджера або в кастомний шорткат
...
Поширюється за ліцензією [MIT](LICENSE). Програмне забезпечення надається «ЯК Є», без жодних гарантій. Використовуєте на свій страх і ризик — автор не несе відповідальності за будь-які наслідки використання.
