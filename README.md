...
- **Кастомні веб-шорткати** — будь-який сайт (Notion, Linear, Claude тощо); підтримується іконка зі списку або перша літера назви, а також власний колір іконки в панелі; кожен шорткат має власну ізольовану сесію — можна мати декілька акаунтів одного сайту; порядок у панелі змінюється перетягуванням. Посилання, які сайт відкриває в новій вкладці, передаються системному браузеру. Сайти з перевіркою «підтвердьте, що ви людина» (Cloudflare Turnstile) працюють нарівні з Safari
