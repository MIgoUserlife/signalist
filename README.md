...
- **Кастомні веб-шорткати** — будь-який сайт (Notion, Linear, Claude тощо); підтримується іконка зі списку або перша літера назви, а також власний колір іконки в панелі; кожен шорткат має власну ізольовану сесію — можна мати декілька акаунтів одного сайту; порядок у панелі змінюється перетягуванням
